                ...
                ->headerActions([
                    ...
                    Action::make('notif_kembali_wa')
                        ...
                        ->action(function (Invoice $record, array $data) {
                            ...
                            // Tanggal & hari dari booking
                            $tglKembali = Carbon::parse($booking->tanggal_kembali);
                            $hariIndo   = [
                                'Sunday'    => 'Minggu',
                                'Monday'    => 'Senin',
                                'Tuesday'   => 'Selasa',
                            ...
                            $namaHari  = $hariIndo[$tglKembali->format('l')] ?? $tglKembali->format('l');
                            $tglFormat = $namaHari . ', ' . $tglKembali->isoFormat('D MMMM Y');

                            // Jam dari form
                            $jamFormat = Carbon::parse($booking->waktu_kembali)->format('H:i');

                            // Wilayah sewa: ambil dari garasi mobil (fallback '-')
                            ...
                            $text   = [];
                            $text[] = "Halo Kak 👋😊";
                            $text[] = "Izin konfirmasi untuk pengembalian unit mobil ya Kak 🚗🙏";
                            $text[] = "";
                            $text[] = "📌 *DETAIL PENGEMBALIAN*";
                            $text[] = "👤 Nama : {$customerName}";
                            $text[] = "🚘 Jenis Mobil : {$carName}";
                            $text[] = "🔢 No. Polisi : {$nopol}";
                            $text[] = "📅 Hari : {$tglFormat}";
                            $text[] = "🕘 Jam Kembali : {$jamFormat}";
