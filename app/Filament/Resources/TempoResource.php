        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\Filter::make('overdue')
                    ...
                    ->toggle()
                    ->query(fn (Builder $q) => $q->whereDate('jatuh_tempo', '<', today()))
                    ->indicateUsing(fn (array $data): ?string =>
                        $data['isActive'] ? '⚠ Melewati jatuh tempo' : null
                    ),
                ...
                Tables\Filters\Filter::make('upcoming_30')
                    ...
                    ->query(fn (Builder $q) => $q
                        ...
                        ->whereDate('jatuh_tempo', '<=', now()->addDays(30))
                    )
                    ->indicateUsing(fn (array $data): ?string =>
                        $data['isActive'] ? '📅 30 hari ke depan' : null
                    ),
            ])
