...
<head>
    ...
    <style>
        ...
        .header-section table { width: 100%; border-bottom: 1px solid #eee; padding-bottom: 10px; }
        ...
        .items-table h3, .payment-details h3 { border-bottom: 1px solid #eee; padding-bottom: 5px; margin-bottom: 10px; font-size: 14px; }
        ...
        .summary-section table { width: 100%; }
        .totals-table { width: 40%; float: right; }
        .totals-table td { padding: 5px 8px; }
        .payment-details { float: left; width: 55%; }
        .text-right { text-align: right; }
        .footer { text-align: center; margin-top: 50px; font-size: 10px; color: #777; position: fixed; bottom: 0; width: 100%; }
        .clear { clear: both; }

        /* -- PERBAIKAN STYLE TANDA TANGAN & STEMPEL -- */
        .signature-section {
            margin-top: 50px;
            text-align: center;
            width: 250px;
    ...
    <div class="container">
        ...
        <div class="signature-section">
            ...
            <div class="signature-container">
                ...
                @endif
                @if($signatureData)
                    <img src="{{ $signatureData }}" alt="Stempel" style="height: 80px; width: auto; opacity: 0.75; display: inline-block; vertical-align: middle;">
                @endif
            </div>
