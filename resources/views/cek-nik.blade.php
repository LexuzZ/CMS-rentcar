                ...
                <form action="{{ route('cek.nik.post') }}" method="POST" class="ck-form">
                    ...
                    <div class="ck-field">
                        ...
                        <div class="ck-input-wrap">
                            ...
                            <input type="text" id="ktp" name="ktp" maxlength="16" class="ck-input"
                                placeholder="Masukkan 16 digit NIK…" inputmode="numeric" autocomplete="off" required
                                value="{{ old('ktp') }}">
