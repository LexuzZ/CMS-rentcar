...
<div x-data="{
    ...
    {{-- Hidden input (galeri) --}}
    <input type="file" accept="image/*" x-ref="fileGallery" class="cc-hidden"
        @change="processFile($event.target.files[0]); $event.target.value = null">

    {{-- Hidden input (kamera langsung — mobile) --}}
    <input type="file" accept="image/*" capture="environment" x-ref="fileCamera" class="cc-hidden"
        @change="processFile($event.target.files[0]); $event.target.value = null">

    {{-- Action buttons --}}
    <div class="cc-actions">
        {{-- Kamera (mobile) --}}
        <button type="button" class="cc-btn cc-btn--primary" @click="$refs.fileCamera.click()" :disabled="loading">
        ...
        {{-- Galeri --}}
        <button type="button" class="cc-btn cc-btn--ghost" @click="$refs.fileGallery.click()" :disabled="loading">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
        ...
        {{-- Hapus --}}
        <button type="button" class="cc-btn cc-btn--danger" x-show="state" x-transition @click="state = null"
            :disabled="loading">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
