<div>
    ...
    <textarea id="text-to-copy-area" readonly
        class="w-full h-48 p-2 border border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
        rows="12"> {{ $textToCopy }}</textarea>
