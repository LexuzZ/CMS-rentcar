<x-filament-panels::page>
    <div class="space-y-6">
                ...
                <x-filament::section
                    ...
                    <div class="flex items-start justify-between pt-3">
                        ...
                        {{-- <div class="p-2.5 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                            <x-filament::icon :icon="$stat['icon']" class="w-6 h-6 text-gray-400 dark:text-gray-300" />
                        </div> --}}
                    </div>
                </x-filament::section>
            @endforeach
        ...
        {{-- Ringkasan Section --}}
        <x-filament::section class="mt-8 shadow-sm border-t-4 border-primary-500 dark:border-primary-600">
            <x-slot name="heading">
            ...
            <div class="space-y-2">
                ...
                <div class="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm">
                    <div
                        class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 px-2 py-2">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach ($rincianTableData as $row)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                        ...
                                        <td
                                            class="px-6 py-4 text-right font-medium tabular-nums dark:text-white whitespace-nowrap">
                ...
                <div class="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm">
                    <div
                        class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 px-6 py-3">
                        <h3 class="font-semibold text-gray-800 dark:text-white">
                            Rincian Pengeluaran
                        </h3>
                    </div>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                @foreach ($summaryTableData as $row)
                                    <tr
                                        ...
                                        <td
                                            class="px-6 py-4 font-medium text-gray-900 dark:text-white hover:text-bg-gray-900 dark:hover:text-bg-gray-900">
                                            @if (is_numeric($row['value']))
                                                Rp {{ number_format($row['value'], 0, ',', '.') }}
                                            @else
                                                {{ $row['value'] }}
