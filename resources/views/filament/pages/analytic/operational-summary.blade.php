<x-filament-panels::page>
                        ...
                        <tbody>
                            @foreach ($rincianTableData as $row)
                                <tr class="rp-tr rp-tr--income">
                                    ...
                                    <td class="rp-td rp-td--value rp-td--income-val">Rp
                        ...
                        <tbody>
                            @foreach ($rincianCostTableData as $row)
                                <tr class="rp-tr rp-tr--expense">
                                    <td class="rp-td rp-td--label">{{ $row['label'] }}</td>
                                    <td class="rp-td rp-td--value rp-td--expense-val">Rp
                                        {{ number_format($row['value'], 0, ',', '.') }}</td>
                                    <td class="rp-td rp-td--center">
                        ...
                        <tbody>
                            @foreach ($summaryTableData as $row)
                                ...
                                <tr class="rp-tr rp-tr--total">
                                    ...
                                    <td class="rp-td rp-td--value rp-td--total-val">Rp
                                        {{ number_format($row['value'], 0, ',', '.') }}</td>
                                    <td class="rp-td rp-td--center">
    ...
    <style>
        ...
        .rp-stat--emerald .rp-stat-bar {
            background: linear-gradient(90deg, #10b981, #34d399);
        }

        .rp-stat--amber .rp-stat-bar {
            background: linear-gradient(90deg, #f59e0b, #fcd34d);
        }

        .rp-stat--rose .rp-stat-bar {
        ...
        .dark .rp-stat-badge--up {
            background: #064e3b;
            color: #4ade80;
        }

        .dark .rp-stat-badge--down {
            background: #450a0a;
            color: #f87171;
        }
        ...
        .dark .rp-report-header {
            background: #111827;
            border-color: #374151;
        }

        .rp-report-header-left {
            display: flex;
            align-items: center;
            gap: 14px;
        }
        ...
        .rp-table-head--income {
            background: #f0fdf4;
            color: #15803d;
        }

        .rp-table-head--expense {
            background: #fff1f2;
            color: #be123c;
        }
        ...
        .dark .rp-table-head--income {
            background: #052e16;
            color: #4ade80;
        }

        .dark .rp-table-head--expense {
            background: #4c0519;
            color: #fb7185;
        }

        .dark .rp-table-head--total {
            background: #1e1b4b;
            color: #a5b4fc;
        }
        ...
        .rp-table-head-dot--expense {
            background: #f43f5e;
        }

        .rp-table-head-dot--total {
            background: #6366f1;
        }
        ...
        .dark .rp-tr--income:hover {
            background: #052e16;
        }

        .dark .rp-tr--expense:hover {
            background: #4c0519;
        }

        .dark .rp-tr--total:hover {
            background: #1e1b4b;
        }
        ...
        .dark .rp-td--income-val {
            color: #4ade80;
        }

        .dark .rp-td--expense-val {
            color: #fb7185;
        }

        .dark .rp-td--total-val {
            color: #a5b4fc;
        }
