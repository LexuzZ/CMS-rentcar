<x-filament-panels::page>
    ...
    <style>
        ...
        .sc-cell--booking .sc-cell-link {
            color: #92400e;
        }

        .sc-cell--disewa .sc-cell-link {
            color: #166534;
        }

        .sc-cell--selesai .sc-cell-link {
            color: #475569;
        }

        .sc-cell--batal .sc-cell-link {
            color: #991b1b;
        }

        .dark .sc-cell--booking .sc-cell-link {
            color: #fbbf24;
        }

        .dark .sc-cell--disewa .sc-cell-link {
            color: #4ade80;
        }

        .dark .sc-cell--selesai .sc-cell-link {
            color: #94a3b8;
        }

        .dark .sc-cell--batal .sc-cell-link {
            color: #f87171;
        }
    </style>
