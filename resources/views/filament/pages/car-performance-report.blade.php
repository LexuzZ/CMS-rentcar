    ...
    <div x-data="{
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-3 text-center">Tidak ada data kinerja mobil untuk periode ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div x-show="isModalOpen"
            ...
            <div @click.away="isModalOpen = false"
                ...
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white" x-text="`Detail Booking untuk ${modalCarName}`"></h3>
                    ...
                    <div class="mt-6 flex justify-between items-center">
                        ...
                        <a :href="`/reports/export-car-bookings/${modalCarId}/${reportDateString.split('-')[0]}/${reportDateString.split('-')[1]}`"
                           style="color: green; text-decoration: none; font-weight: 500; background-color: #10b981; padding: 0.25rem; border-radius: 0.375rem; hover::background-color: #059669;">
