...
<div class="bg-white p-6 rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
    ...
    <div class="space-y-3 text-sm">
        ...
        <div class="flex justify-between">
            ...
            <span class=" bg-green-500 text-gray-900 dark:text-white text-xs">
                {{ $record->driverPengantaran->nama ?? 'N/A' }}
            </span>
        </div>

        <div class="flex justify-between items-center">
            <span class="text-gray-500 dark:text-gray-400 text-xs">Waktu Keluar</span>
        ...
        <div class="flex justify-between items-center">
            <span class="text-gray-500 dark:text-gray-400 text-xs">Tgl Keluar</span>
            <div class="text-right">
                <p class=" text-xs">
    ...
    @if ($canPerformActions)
        <div class="mt-6 flex items-center justify-between">
            ...
            <x-filament::button tag="a"
                ...
                icon="heroicon-o-pencil-square" color="gray" style="background-color:#fff; color:#000;"
