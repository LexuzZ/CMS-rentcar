<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <style>
            ...
            .ow-col-header.warning .ow-col-title {
                color: #92400e;
            }

            .ow-col-header.danger .ow-col-title {
                color: #991b1b;
            }
            ...
            .ow-card.warning::before {
                background: linear-gradient(90deg, rgba(251, 191, 36, .06), transparent);
            }

            .ow-card.danger::before {
                background: linear-gradient(90deg, rgba(248, 113, 113, .06), transparent);
            }
            ...
            .ow-card.warning .ow-divider {
                border-color: #fef3c7;
            }

            .ow-card.danger .ow-divider {
                border-color: #fee2e2;
            }
            ...
            .ow-btn.warning:hover {
                filter: brightness(.92);
                box-shadow: 0 5px 14px rgba(217, 119, 6, .4);
            }
            ...
            .dark .ow-card.warning:hover {
                box-shadow: 0 4px 16px rgba(180, 83, 9, .2);
            }

            .dark .ow-card.danger:hover {
            ...
            .dark .ow-time-rel.warning {
                color: #fbbf24;
            }

            .dark .ow-time-rel.danger {
                color: #f87171;
            }
            ...
            .dark .ow-col-header.warning {
                background: #1c1007;
                border-color: #44321a;
            }

            .dark .ow-col-header.danger {
                background: #1a0a0a;
                border-color: #3f1d1d;
            }

            .dark .ow-col-header.warning .ow-col-title {
                color: #fbbf24;
            }

            .dark .ow-col-header.danger .ow-col-title {
                color: #f87171;
            }

            .dark .ow-badge.warning {
                background: #1c1007;
                border-color: #44321a;
                color: #fbbf24;
            }

            .dark .ow-badge.danger {
                background: #1a0a0a;
                border-color: #3f1d1d;
                color: #f87171;
            }

            .dark .ow-col-icon.warning {
                background: #1c1007;
                border-color: #44321a;
            }

            .dark .ow-col-icon.danger {
                background: #1a0a0a;
                border-color: #3f1d1d;
            }
