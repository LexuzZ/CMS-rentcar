<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <style>
            ...
            .af-stat.created::before {
                background: linear-gradient(90deg, #10b981, #34d399);
            }

            .af-stat.updated::before {
                background: linear-gradient(90deg, #3b82f6, #60a5fa);
            }

            .af-stat.deleted::before {
            ...
            .af-stat.created .af-stat-icon {
                background: rgba(16, 185, 129, .15);
            }

            .af-stat.updated .af-stat-icon {
                background: rgba(59, 130, 246, .12);
            }

            .af-stat.deleted .af-stat-icon {
            ...
            .af-stat.created .af-stat-val {
                color: #047857;
            }

            .af-stat.updated .af-stat-val {
                color: #1e40af;
            }

            .af-stat.deleted .af-stat-val {
                color: #b91c1c;
            }
            ...
            /* Dark stat cards */
            .dark .af-stat.created {
                background: linear-gradient(160deg, #052e16, #14532d);
                border-color: #166534;
            }

            .dark .af-stat.updated {
                background: linear-gradient(160deg, #0c1a33, #1e3a5f);
                border-color: #1d4ed8;
            }

            .dark .af-stat.deleted {
                background: linear-gradient(160deg, #1a0505, #3f1d1d);
                border-color: #7f1d1d;
            }

            .dark .af-stat.created .af-stat-icon {
                background: rgba(16, 185, 129, .2);
            }

            .dark .af-stat.updated .af-stat-icon {
                background: rgba(59, 130, 246, .2);
            }

            .dark .af-stat.deleted .af-stat-icon {
                background: rgba(239, 68, 68, .2);
            }

            .dark .af-stat.created .af-stat-val {
                color: #4ade80;
            }

            .dark .af-stat.updated .af-stat-val {
                color: #60a5fa;
            }

            .dark .af-stat.deleted .af-stat-val {
                color: #f87171;
            }
            ...
            .af-fbtn.fe-active-all {
                background: #1f2937;
                color: #fff !important;
            }

            .af-fbtn.fe-active-created {
                background: #047857;
                color: #fff !important;
            }

            .af-fbtn.fe-active-updated {
                background: #1e40af;
                color: #fff !important;
            }

            .af-fbtn.fe-active-deleted {
                background: #b91c1c;
                color: #fff !important;
            }
            ...
            .af-event-dot.created {
                background: #10b981;
            }

            .af-event-dot.updated {
                background: #3b82f6;
            }

            .af-event-dot.deleted {
                background: #ef4444;
            }
            ...
            .af-item:hover .af-item-card {
                background: #f3f4f6;
            }

            .dark .af-item:hover .af-item-card {
                background: #111110;
            }
        ...
        @if($activities->isEmpty())
            <div class="af-empty">
                <div class="af-empty-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path d="M12 20h9" />
                        <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" />
                    </svg>
                    ...
                    <div class="af-item">
                        <div class="af-avatar-col">
                            ...
                            <div class="af-event-dot {{ $eventClass }}">
                                <svg width="7" height="7" viewBox="0 0 12 12" fill="none" stroke="#fff" stroke-width="2.5"
                                    stroke-linecap="round">{!! $dotIcon !!}</svg>
                            </div>
                        </div>
                        ...
                        <div class="af-item-card">
                            <div class="af-item-top">
                                ...
                                <div style="text-align:right;flex-shrink:0;">
                                    ...
                                    <span
                                        class="af-time-abs">{{ \Carbon\Carbon::parse($activity['timeAbs'])->format('H:i') }}</span>
                                </div>
                            </div>
                                    ...
                                    @foreach($activity['changedFields'] as $field)
                                        <span class="af-field-chip">
                                            <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2.5">
                                                <path d="M12 20h9" />
                                                <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4L16.5 3.5z" />
                                            </svg>
                                            {{ str_replace('_', ' ', $field) }}
                                        </span>
                                    @endforeach
