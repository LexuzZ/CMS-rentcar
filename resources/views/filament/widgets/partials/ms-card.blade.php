...
<div class="bc-card">
    ...
    <div class="bc-inner">
        ...
        {{-- ── Header ── --}}
        <div class="bc-header">
            <div class="bc-car-icon"
                style="background:{{ $accentLight }};border-color:{{ $accentBorder }};color:{{ $accentColor }};">
            ...
            <span class="bc-badge"
                style="background:{{ $accentLight }};color:{{ $accentText }};border-color:{{ $accentBorder }};">
                {{ $statusText }}
            </span>
        </div>
        ...
        <div class="bc-rows">
            ...
            <div class="bc-row">
                <span class="bc-row-icon">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path
                            d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.62 3.45 2 2 0 0 1 3.59 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.6a16 16 0 0 0 6.29 6.29l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
                    </svg>
                </span>
            ...
            <div class="bc-row">
                ...
                <span class="bc-row-value">
                    {{ $booking->total_hari ?? \Carbon\Carbon::parse($booking->tanggal_keluar)->diffInDays($booking->tanggal_kembali) }}
                    hari
                    &nbsp;·&nbsp;
        ...
        @if($canPerformActions)
            <div class="bc-actions">
                ...
                @if($isKeluar)
                    <button wire:click="pickupBooking({{ $booking->id }})" wire:loading.attr="disabled"
                        class="bc-btn bc-btn--primary" style="background:{{ $btnColor }};"
                ...
                @else
                    <button wire:click="selesaikanBooking({{ $booking->id }})" wire:loading.attr="disabled"
                        class="bc-btn bc-btn--primary" style="background:{{ $btnColor }};"
                        onmouseover="this.style.background='{{ $btnHover }}'"
                        onmouseout="this.style.background='{{ $btnColor }}'">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
