<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <style>
            ...
            .ams-card.gray::before {
                background: linear-gradient(90deg, #6b7280, #9ca3af);
            }

            .ams-card.green::before {
                background: linear-gradient(90deg, #10b981, #34d399);
            }

            .ams-card.yellow::before {
                background: linear-gradient(90deg, #f59e0b, #fbbf24);
            }

            .ams-card.blue::before {
            ...
            .ams-card.gray .ams-card-icon {
                background: rgba(107, 114, 128, .12);
            }

            .ams-card.green .ams-card-icon {
                background: rgba(16, 185, 129, .15);
            }

            .ams-card.yellow .ams-card-icon {
                background: rgba(245, 158, 11, .15);
            }

            .ams-card.blue .ams-card-icon {
                background: rgba(59, 130, 246, .12);
            }

            .ams-card.red .ams-card-icon {
                background: rgba(239, 68, 68, .12);
            }

            .ams-card.slate .ams-card-icon {
            ...
            .ams-card.gray .ams-card-val {
                color: #374151 !important;
            }

            .ams-card.green .ams-card-val {
                color: #047857 !important;
            }

            .ams-card.yellow .ams-card-val {
                color: #92400e !important;
            }

            .ams-card.blue .ams-card-val {
                color: #1e40af !important;
            }

            .ams-card.red .ams-card-val {
                color: #991b1b !important;
            }

            .ams-card.slate .ams-card-val {
                color: #475569 !important;
            }

            .dark .ams-card.gray .ams-card-val {
                color: #d4d0cb !important;
            }

            .dark .ams-card.green .ams-card-val {
                color: #4ade80 !important;
            }

            .dark .ams-card.yellow .ams-card-val {
                color: #fcd34d !important;
            }

            .dark .ams-card.blue .ams-card-val {
                color: #60a5fa !important;
            }

            .dark .ams-card.red .ams-card-val {
                color: #f87171 !important;
            }

            .dark .ams-card.slate .ams-card-val {
            ...
            .ams-progress-pct.good {
                color: #047857 !important;
            }

            .ams-progress-pct.medium {
                color: #92400e !important;
            }

            .ams-progress-pct.bad {
                color: #991b1b !important;
            }

            .dark .ams-progress-pct.good {
                color: #4ade80 !important;
            }

            .dark .ams-progress-pct.medium {
                color: #fcd34d !important;
            }

            .dark .ams-progress-pct.bad {
                color: #f87171 !important;
            }
        ...
        $isSuperadmin = Auth::user()->role === 'superadmin'; @endphp
