    ...
    <x-filament::section>
        ...
        <x-slot name="heading">
            <div style="display:flex;align-items:center;justify-content:space-between;width:100%;">
                ...
                <div id="aw-live-time" style="font-size:18px;font-weight:800;
                     color:var(--fi-color-gray-900,#111827);
        ...
        <style>
            ...
            .dark .aw-status-card.idle {
                background: linear-gradient(135deg, #0c1a33, rgba(14, 165, 233, .12));
                border-color: #0369a1;
            }

            .dark .aw-status-card.done {
                background: linear-gradient(135deg, #052e16, #14532d);
                border-color: #166534;
            }

            .dark .aw-status-card.late {
                background: linear-gradient(135deg, #1c1408, #3d2e00);
                border-color: #92400e;
            }
            ...
            .aw-status-card.idle .aw-status-icon {
                background: rgba(14, 165, 233, .15);
            }

            .aw-status-card.done .aw-status-icon {
                background: rgba(16, 185, 129, .15);
            }

            .aw-status-card.late .aw-status-icon {
            ...
            .aw-status-card.idle .aw-status-title {
                color: #0c4a6e !important;
            }

            .aw-status-card.done .aw-status-title {
                color: #14532d !important;
            }

            .aw-status-card.late .aw-status-title {
                color: #78350f !important;
            }

            .dark .aw-status-card.idle .aw-status-title {
                color: #7dd3fc !important;
            }

            .dark .aw-status-card.done .aw-status-title {
                color: #4ade80 !important;
            }

            .dark .aw-status-card.late .aw-status-title {
            ...
            /* Error — terhubung ke $errorMessage Livewire */
            .aw-error {
                width: 100%;
                padding: 12px 16px;
                border-radius: 10px;
        ...
        <div class="aw-wrap">
            ...
            @else
                <div class="aw-status-card idle">
                    <div class="aw-status-icon">
                        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#0ea5e9" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="10" />
                            <polyline points="12 6 12 12 16 14" />
                        </svg>
            ...
            {{-- ── ERROR: terhubung ke $errorMessage dari widget PHP ── --}}
            @if($errorMessage)
                <div class="aw-error">
            ...
            {{-- ── JS error box (untuk error GPS sebelum sampai ke server) ── --}}
            <div id="aw-js-error" class="aw-error" style="display:none;">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" style="flex-shrink:0;margin-top:1px;">
                    <circle cx="12" cy="12" r="10" />
                    <line x1="12" y1="8" x2="12" y2="12" />
        ...
        <script>
            ...
            function awStartCheckIn() {
                ...
                navigator.geolocation.getCurrentPosition(
                    ...
                    function (err) {
                        const msgs = {
                            1: 'Akses lokasi ditolak. Izinkan GPS di browser lalu coba lagi.',
