<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <style>
            ...
            .dark .aw-status-card.idle  { background:linear-gradient(135deg,#0c1a33,rgba(14,165,233,.12)); border-color:#0369a1; }
            ...
            .aw-recap { width:100%; display:grid; grid-template-columns:repeat(3,1fr); gap:10px; }
            .aw-recap-item {
            ...
            .aw-recap-val { font-size:18px; font-weight:800; }
        ...
        <div class="aw-wrap">
            ...
            @else
                <div class="aw-status-card idle">
                    <div class="aw-status-icon">
                        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#0ea5e9"
                             stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="10"/>
                            <polyline points="12 6 12 12 16 14"/>
                        </svg>
