    ...
    <x-filament::section>
        ...
        <x-slot name="heading">
            <span class="flex items-center gap-2">
                ...
                <span class="lb-heading-text">Peringkat Staff Bulanan</span>
            </span>
        </x-slot>
                ...
                <tbody>
                    @forelse ($stats as $stat)
                        ...
                        <tr class="lb-tr {{ $isTop3 ? 'lb-tr--top3' : '' }}">
                            ...
                            <td class="lb-td lb-td--center">
                                <span class="lb-badge"
                                    style="background:{{ $totalBg }};color:{{ $totalColor }};border-color:{{ $totalBorder }};">
                                    {{ $stat['total'] }}
                                </span>
                            </td>
                        ...
                        <tr>
                            <td colspan="5">
                                <div class="lb-empty">
                                    ...
                                    <p class="lb-empty-sub">Tidak ada penugasan driver pada bulan ini.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
        ...
        <p class="lb-footer-note">
            💡 Menampilkan kinerja driver pada bulan {{ $dateForHumans }}.
        </p>
        ...
        <style>
            ...
            .lb-avatar--silver {
                ...
                color: #475569;
                border-color: #cbd5e1;
                box-shadow: 0 3px 10px rgba(100, 116, 139, .2);
            }
            ...
            .lb-avatar--bronze {
                ...
                color: #c2410c;
                border-color: #fdba74;
                box-shadow: 0 3px 10px rgba(194, 65, 12, .2);
            }
