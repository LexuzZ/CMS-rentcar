        ...
        <div class="tp-grid">
            @forelse ($tempos as $record)
                ...
                <div class="tp-card" style="border-color:{{ $accentBorder }};">
                    ...
                    {{-- Subtle tint --}}
                    <div class="tp-tint" style="background:linear-gradient(135deg,{{ $accentLight }},transparent 60%);">
                    </div>
                    ...
                    <div class="tp-body">
                        ...
                        <div class="tp-header">
                            ...
                            <span class="tp-urgency-badge"
                                style="background:{{ $badgeBg }};color:{{ $badgeText }};border-color:{{ $accentBorder }};">
                                {{ $label }}
                            </span>
                        </div>
                        ...
                        {{-- Action --}}
                        <button wire:click="selesaikanTempo({{ $record->id }})" wire:loading.attr="disabled" class="tp-btn"
                            style="background:{{ $accentColor }};" onmouseover="this.style.filter='brightness(.88)'"
