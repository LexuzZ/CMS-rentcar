    ...
    <x-filament::section>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2">
            ...
            <a href="{{ \App\Filament\Resources\PaymentResource::getUrl('index') }}"
                class="flex flex-col items-center justify-center p-2 border rounded-lg shadow-sm bg-gray-900 hover:bg-gray-50 dark:bg-amber-50 dark:hover:bg-gray-900 transition-colors">
