    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        <span class="text-xs font-medium py-0.5 rounded-full">
                            ...
                            @php
                                ...
                                $labelHari = match (true) {
                                    $tglKeluar->isSameDay($today) => 'Mobil Keluar Hari Ini',
                                    $tglKeluar->isSameDay($tomorrow) => 'Mobil Keluar Besok',
        ...
        @empty
            <div class="col-span-full text-center text-gray-500 dark:text-gray-400">
                Tidak ada mobil yang dijadwalkan keluar hari ini atau besok.
            </div>
        @endforelse
    </div>
</x-filament-widgets::widget>
