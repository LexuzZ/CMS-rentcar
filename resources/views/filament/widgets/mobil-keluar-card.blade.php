    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
            ...
            <div class="flex items-start justify-between">
                <div>
                    {{-- PERUBAHAN DI SINI: Menampilkan Merek dan Model Mobil --}}
                ...
                $statusText = match($status) { 'booking' => 'Booking', default => ucfirst($status) };
                @endphp
        ...
        <div class="col-span-full text-center text-gray-500 dark:text-gray-400">
            Tidak ada mobil yang dijadwalkan keluar hari ini.
        </div>
        @endforelse
    </div>
</x-filament-widgets::widget>
