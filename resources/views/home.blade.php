            ...
            <form method="GET" action="{{ route('home') }}" id="search-form">
                ...
                <div class="flex gap-2">
                    <div
                        ...
                        <svg class="text-gray-400 flex-shrink-0" width="16" height="16" viewBox="0 0 24 24"
                    ...
                    <button type="submit"
                        class="bg-brand bg-brand-hover text-white font-bold text-sm px-6 rounded-xl transition shadow-sm">
                        Cari
                    </button>
                </div>
        ...
        @if ($cars->isEmpty())
            ...
            <div class="flex flex-col items-center justify-center py-24 text-center">
                <div class="w-20 h-20 bg-orange-50 rounded-2xl flex items-center justify-center mb-4">
                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#c2410c"
                ...
                @foreach ($cars as $car)
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden card-hover shadow-sm">
                        ...
                        <div class="relative bg-gray-50 aspect-[4/3] overflow-hidden">
                            <img src="{{ $foto }}" alt="{{ $namaLengkap }}"
                                class="w-full h-full object-contain p-3"
                                onerror="this.src='{{ asset('images/car-placeholder.png') }}'">

                            {{-- Badge tersedia --}}
                            <span
                                class="absolute top-3 left-3 text-xs font-bold px-2.5 py-1 rounded-full {{ $badgeColor }}">
                                Tersedia
                            </span>
