...
<body class="hp-body">
        ...
        @else
            ...
            @if($cars->hasPages())
                <div class="hp-pagination">
                    {{-- Preserve semua query string filter saat pindah halaman --}}
    ...
    <style>
        ...
        *::after {
        ...
        /* Reset Bootstrap bawaan Laravel & ganti dengan style custom */
        .hp-pagination nav {
            display: flex;
            justify-content: center;
        }
        ...
        /* Hilangkan teks "Showing X to Y of Z results" */

        /* Wrapper <ul> dari Bootstrap 5 pagination */
        ...
        /* Tombol/link <a> dan <span> di dalam <li> */
        ...
        /* Disabled (prev/next saat di ujung) */
        ...
        /* Tombol Prev/Next — sedikit lebih lebar */
