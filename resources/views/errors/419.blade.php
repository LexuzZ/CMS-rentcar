...
<body>
    ...
    <div class="card">
        ...
        {{-- Animated clock icon --}}
        <div class="icon-wrap">
            <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#d97706" stroke-width="1.75"
        ...
        <div class="info-box">
            ...
            <p class="info-box-text">
                ...
                Token keamanan (CSRF) sudah tidak valid. Hal ini terjadi saat halaman dibuka terlalu lama, atau setelah
                Anda logout lalu kembali ke halaman yang sama.
            </p>
        </div>
