...
<body class="fb-body">
                ...
                <form id="bookingForm" class="fb-form">
                    ...
                    <div class="fb-field">
                        ...
                        <div class="fb-input-wrap">
                            ...
                            <input type="text" id="lokasi_pengantaran" class="fb-input"
                    ...
                    <div class="fb-field">
                        ...
                        <div class="fb-input-wrap">
                            ...
                            <input type="text" id="lokasi_pengembalian" class="fb-input"
                                placeholder="Hotel / Bandara / Alamat…" required>
                        </div>
                    </div>
    ...
    <style>
        ...
        *::after {
        ...
        .fb-customer-greeting {
            font-size: 13.5px;
            color: #1e3a5f;
        }

        .fb-customer-greeting strong {
            font-weight: 700;
        }
